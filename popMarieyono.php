...
<meta property="og:url" content="http://pop-it.click?id=MarieYono"> <!--mod-->
<meta property="og:title" content="Pop-it!">
<meta property="og:description" content="Pop your Waifu">
<meta property="og:image" content="http://pop-it.click/marie01.jpeg"> <!--mod-->

<!-- Twitter -->
<meta property="twitter:card" content="summary_large_image">
<meta property="twitter:url" content="http://pop-it.click?id=MarieYono"> <!--mod-->
<meta property="twitter:title" content="Pop-it!">
<meta property="twitter:description" content="Pop your Waifu">
<meta property="twitter:image" content="http://pop-it.click/marie01.jpeg"> <!--mod-->
</head>
<script>
var counter = 0;
var audio = [];
...
function movetoimagechange()
{
  ...
  document.getElementById('artist').style.zIndex = 501;
...
<?
    $img1name = 'marie00.jpeg'; /* mod */
    $img2name = 'marie01.jpeg'; /* mod */
    ...
    if(isset($_POST['submit']))
    {
      ...
      if (preg_match("/\.(jpg|png)$/i", $upload_img1) && preg_match("/\.(jpg|png)$/i", $upload_img2))
      {
...
<body>
  ...
  <div id = "getfilediv">
    ...
    <form id = "getfileform" action='<? echo htmlspecialchars($_SERVER['PHP_SELF']); ?>' method="post" enctype="multipart/form-data">
      ...
      Files with non-english names won't work.(ex : ヌンボラ01.png)<br>
      Portrait images (around 16~20:9~10) would be highly recommended.<br>
      DM me if you wish to share pop links of images you uploaded.<br>
      </p>
  ...
  <div id=artist>
    ...
    <p>
      Drawn by...<br> <!--mod-->
      <a href = "" target='_blank'>twitter</a><br> <!--mod-->
      <a href = "" target='_blank'>pixiv</a><br> <!--mod-->
    </p>
  </div>
</body>
</html>
